...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "testchain.testchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "testchain.testchain.QueryParamsResponse")
}
...
var fileDescriptor_f06cd066eb8a7bf0 = []byte{
	...
	0x49, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0xb0, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a,
	...
	0x36, 0xa1, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c, 0x64, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x87, 0x7c, 0xc8, 0xb8, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/testchain.testchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testchain.testchain.Query/Params",
	}

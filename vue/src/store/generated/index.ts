...
import TestchainTestchain from './testchain.testchain'
...
import CosmosCircuitV1 from './cosmos.circuit.v1'
...
import IbcCoreChannelV2 from './ibc.core.channel.v2'
import IbcCoreClientV1 from './ibc.core.client.v1'
import IbcCoreClientV2 from './ibc.core.client.v2'
...
export default { 
  TestchainTestchain: load(TestchainTestchain, 'testchain.testchain'),
  ...
  CosmosCircuitV1: load(CosmosCircuitV1, 'cosmos.circuit.v1'),
  ...
  IbcCoreChannelV2: load(IbcCoreChannelV2, 'ibc.core.channel.v2'),
  IbcCoreClientV1: load(IbcCoreClientV1, 'ibc.core.client.v1'),
  IbcCoreClientV2: load(IbcCoreClientV2, 'ibc.core.client.v2'),

...
import { Permissions } from "testchain-client-ts/cosmos.circuit.v1/types"
import { GenesisAccountPermissions } from "testchain-client-ts/cosmos.circuit.v1/types"


export { Permissions, GenesisAccountPermissions };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						GenesisAccountPermissions: getStructure(GenesisAccountPermissions.fromPartial({})),

...
export { TextProposal, QueryDepositResponse, QueryDepositsRequest, QueryDepositsResponse, TallyParams, VotingParams, QueryVoteRequest, QueryVotesResponse, QueryTallyResultResponse, DepositParams, QueryProposalsResponse, TallyResult, MsgDeposit, MsgDepositResponse, Deposit, QueryVotesRequest, MsgVote, Proposal, GenesisState, QueryDepositRequest, WeightedVoteOption, Vote, QueryProposalRequest, QueryVoteResponse, QueryParamsResponse, MsgSubmitProposalResponse, MsgVoteResponse, MsgVoteWeightedResponse, QueryParamsRequest, MsgVoteWeighted, MsgSubmitProposal, QueryProposalResponse, QueryProposalsRequest, QueryTallyResultRequest };

...
import { MsgIBCSend as typeMsgIBCSend} from "./types"
import { MsgIBCSendResponse as typeMsgIBCSendResponse} from "./types"
import { MsgIBCWriteAcknowledgementResponse as typeMsgIBCWriteAcknowledgementResponse} from "./types"
import { MsgIBCCloseChannel as typeMsgIBCCloseChannel} from "./types"
...
export { QueryContractsByCodeRequest, QueryCodeInfoResponse, AccessConfig, ContractCodeHistoryEntry, QueryCodeResponse, MsgInstantiateContract2Response, MaxFundsLimit, MsgIBCSend, MsgStoreCodeResponse, MsgClearAdmin, MsgSudoContractResponse, QueryCodeInfoRequest, Params, InstantiateContractProposal, MsgClearAdminResponse, QueryWasmLimitsConfigResponse, MsgStoreCode, MsgExecuteContract, MsgUpdateInstantiateConfig, ContractExecutionAuthorization, Sequence, MsgInstantiateContractResponse, MsgPinCodesResponse, MsgUpdateParamsResponse, MaxCallsLimit, MsgUpdateAdmin, MsgUnpinCodes, QueryCodesResponse, QueryContractInfoResponse, UnpinCodesProposal, MsgUnpinCodesResponse, MsgStoreAndInstantiateContractResponse, MsgRemoveCodeUploadParamsAddressesResponse, ContractMigrationAuthorization, QueryAllContractStateResponse, MsgAddCodeUploadParamsAddresses, MsgStoreAndMigrateContract, MsgUpdateContractLabel, Model, QuerySmartContractStateResponse, MsgUpdateAdminResponse, ContractInfo, QueryContractHistoryRequest, MsgAddCodeUploadParamsAddressesResponse, MsgStoreAndMigrateContractResponse, MsgUpdateContractLabelResponse, QueryRawContractStateResponse, QueryPinnedCodesResponse, MigrateContractProposal, UpdateInstantiateConfigProposal, CodeInfo, MsgIBCCloseChannel, QueryPinnedCodesRequest, QueryContractsByCreatorRequest, PinCodesProposal, MsgExecuteContractResponse, QueryBuildAddressRequest, ClearAdminProposal, StoreAndInstantiateContractProposal, GenesisState, Code, QuerySmartContractStateRequest, QueryWasmLimitsConfigRequest, MsgRemoveCodeUploadParamsAddresses, Contract, QueryContractsByCreatorResponse, MsgIBCSendResponse, QueryContractsByCodeResponse, MsgMigrateContractResponse, QueryCodesRequest, ExecuteContractProposal, MsgInstantiateContract2, MsgStoreAndInstantiateContract, ContractGrant, QueryContractHistoryResponse, CodeInfoResponse, QueryBuildAddressResponse, SudoContractProposal, MsgUpdateInstantiateConfigResponse, MsgPinCodes, AccessTypeParam, QueryParamsRequest, MsgMigrateContract, MsgUpdateParams, CodeGrant, MsgIBCWriteAcknowledgementResponse, InstantiateContract2Proposal, QueryCodeRequest, StoreCodeProposal, AcceptedMessageKeysFilter, AcceptedMessagesFilter, QueryContractInfoRequest, QueryParamsResponse, MsgInstantiateContract, MsgSudoContract, AllowAllMessagesFilter, QueryAllContractStateRequest, QueryRawContractStateRequest, AccessConfigUpdate, AbsoluteTxPosition, StoreCodeAuthorization, CombinedLimit, UpdateAdminProposal };
...
type sendQueryCodeInfoResponseParams = {
  value: QueryCodeInfoResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryCodeInfoRequestParams = {
  value: QueryCodeInfoRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryWasmLimitsConfigResponseParams = {
  value: QueryWasmLimitsConfigResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryWasmLimitsConfigRequestParams = {
  value: QueryWasmLimitsConfigRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgIBCWriteAcknowledgementResponseParams = {
  value: MsgIBCWriteAcknowledgementResponse,
  fee?: StdFee,
  memo?: string
};
...
type queryCodeInfoResponseParams = {
  value: QueryCodeInfoResponse,
};
...
type queryCodeInfoRequestParams = {
  value: QueryCodeInfoRequest,
};
...
type queryWasmLimitsConfigResponseParams = {
  value: QueryWasmLimitsConfigResponse,
};
...
type queryWasmLimitsConfigRequestParams = {
  value: QueryWasmLimitsConfigRequest,
};
...
type msgIbcwriteAcknowledgementResponseParams = {
  value: MsgIBCWriteAcknowledgementResponse,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendQueryCodeInfoResponse({ value, fee, memo }: sendQueryCodeInfoResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryCodeInfoResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryCodeInfoResponse({ value: QueryCodeInfoResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryCodeInfoResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryCodeInfoRequest({ value, fee, memo }: sendQueryCodeInfoRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryCodeInfoRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryCodeInfoRequest({ value: QueryCodeInfoRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryCodeInfoRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryWasmLimitsConfigResponse({ value, fee, memo }: sendQueryWasmLimitsConfigResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryWasmLimitsConfigResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryWasmLimitsConfigResponse({ value: QueryWasmLimitsConfigResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryWasmLimitsConfigResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryWasmLimitsConfigRequest({ value, fee, memo }: sendQueryWasmLimitsConfigRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryWasmLimitsConfigRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryWasmLimitsConfigRequest({ value: QueryWasmLimitsConfigRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryWasmLimitsConfigRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgIBCWriteAcknowledgementResponse({ value, fee, memo }: sendMsgIBCWriteAcknowledgementResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgIBCWriteAcknowledgementResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgIbcwriteAcknowledgementResponse({ value: MsgIBCWriteAcknowledgementResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgIBCWriteAcknowledgementResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		queryCodeInfoResponse({ value }: queryCodeInfoResponseParams): EncodeObject {
			try {
				return { typeUrl: "/cosmwasm.wasm.v1.QueryCodeInfoResponse", value: QueryCodeInfoResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryCodeInfoResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryCodeInfoRequest({ value }: queryCodeInfoRequestParams): EncodeObject {
			try {
				return { typeUrl: "/cosmwasm.wasm.v1.QueryCodeInfoRequest", value: QueryCodeInfoRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryCodeInfoRequest: Could not create message: ' + e.message)
			}
		},
		...
		queryWasmLimitsConfigResponse({ value }: queryWasmLimitsConfigResponseParams): EncodeObject {
			try {
				return { typeUrl: "/cosmwasm.wasm.v1.QueryWasmLimitsConfigResponse", value: QueryWasmLimitsConfigResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryWasmLimitsConfigResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryWasmLimitsConfigRequest({ value }: queryWasmLimitsConfigRequestParams): EncodeObject {
			try {
				return { typeUrl: "/cosmwasm.wasm.v1.QueryWasmLimitsConfigRequest", value: QueryWasmLimitsConfigRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryWasmLimitsConfigRequest: Could not create message: ' + e.message)
			}
		},
		...
		msgIbcwriteAcknowledgementResponse({ value }: msgIbcwriteAcknowledgementResponseParams): EncodeObject {
			try {
				return { typeUrl: "/cosmwasm.wasm.v1.MsgIBCWriteAcknowledgementResponse", value: MsgIBCWriteAcknowledgementResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgIBCWriteAcknowledgementResponse: Could not create message: ' + e.message)
			}
		},
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						MsgIBCSend: getStructure(typeMsgIBCSend.fromPartial({})),
						MsgIBCSendResponse: getStructure(typeMsgIBCSendResponse.fromPartial({})),
						MsgIBCWriteAcknowledgementResponse: getStructure(typeMsgIBCWriteAcknowledgementResponse.fromPartial({})),
						MsgIBCCloseChannel: getStructure(typeMsgIBCCloseChannel.fromPartial({})),

...
export const InstantiateContract2Proposal: MessageFns<InstantiateContract2Proposal> = {
  encode(message: InstantiateContract2Proposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
...
export const SudoContractProposal: MessageFns<SudoContractProposal> = {
  encode(message: SudoContractProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
...
export const ExecuteContractProposal: MessageFns<ExecuteContractProposal> = {
  encode(message: ExecuteContractProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
...
export const AccessConfigUpdate: MessageFns<AccessConfigUpdate> = {
  encode(message: AccessConfigUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.codeId !== 0) {
      writer.uint32(8).uint64(message.codeId);
    }
    if (message.instantiatePermission !== undefined) {
      AccessConfig.encode(message.instantiatePermission, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const UpdateInstantiateConfigProposal: MessageFns<UpdateInstantiateConfigProposal> = {
  encode(message: UpdateInstantiateConfigProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
...
export const StoreAndInstantiateContractProposal: MessageFns<StoreAndInstantiateContractProposal> = {
  encode(message: StoreAndInstantiateContractProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {

...
export { MsgCreateClientResponse, MsgUpdateClient, MsgSubmitMisbehaviourResponse, ConsensusStateWithHeight, QueryConsensusStateHeightsRequest, QueryVerifyMembershipResponse, MsgDeleteClientCreator, GenesisMetadata, Params, MsgUpgradeClientResponse, MsgIBCSoftwareUpgradeResponse, Height, QueryClientStatesRequest, QueryConsensusStateRequest, QueryConsensusStatesRequest, QueryClientParamsRequest, MsgUpdateClientResponse, MsgUpgradeClient, MsgRecoverClient, MsgUpdateParamsResponse, GenesisState, QueryClientStatesResponse, QueryClientCreatorRequest, QueryUpgradedClientStateRequest, MsgSubmitMisbehaviour, MsgUpdateParams, QueryConsensusStateResponse, ClientConsensusStates, QueryClientStateRequest, MsgIBCSoftwareUpgrade, MsgDeleteClientCreatorResponse, IdentifiedGenesisMetadata, QueryClientStateResponse, QueryConsensusStatesResponse, QueryConsensusStateHeightsResponse, QueryClientStatusRequest, QueryClientStatusResponse, QueryClientParamsResponse, QueryClientCreatorResponse, QueryUpgradedConsensusStateRequest, QueryUpgradedConsensusStateResponse, QueryVerifyMembershipRequest, MsgCreateClient, MsgRecoverClientResponse, IdentifiedClientState, QueryUpgradedClientStateResponse };
...
type sendQueryClientCreatorRequestParams = {
  value: QueryClientCreatorRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgDeleteClientCreatorResponseParams = {
  value: MsgDeleteClientCreatorResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryClientCreatorResponseParams = {
  value: QueryClientCreatorResponse,
  fee?: StdFee,
  memo?: string
};
...
type queryClientCreatorRequestParams = {
  value: QueryClientCreatorRequest,
};
...
type msgDeleteClientCreatorResponseParams = {
  value: MsgDeleteClientCreatorResponse,
};
...
type queryClientCreatorResponseParams = {
  value: QueryClientCreatorResponse,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendQueryVerifyMembershipResponse({ value, fee, memo }: sendQueryVerifyMembershipResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryVerifyMembershipResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryVerifyMembershipResponse({ value: QueryVerifyMembershipResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryVerifyMembershipResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendMsgDeleteClientCreator({ value, fee, memo }: sendMsgDeleteClientCreatorParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendQueryClientCreatorRequest({ value, fee, memo }: sendQueryClientCreatorRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryClientCreatorRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryClientCreatorRequest({ value: QueryClientCreatorRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryClientCreatorRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgDeleteClientCreatorResponse({ value, fee, memo }: sendMsgDeleteClientCreatorResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgDeleteClientCreatorResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgDeleteClientCreatorResponse({ value: MsgDeleteClientCreatorResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgDeleteClientCreatorResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryClientCreatorResponse({ value, fee, memo }: sendQueryClientCreatorResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryClientCreatorResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryClientCreatorResponse({ value: QueryClientCreatorResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryClientCreatorResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryVerifyMembershipRequest({ value, fee, memo }: sendQueryVerifyMembershipRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryVerifyMembershipRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryVerifyMembershipRequest({ value: QueryVerifyMembershipRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryVerifyMembershipRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		queryVerifyMembershipResponse({ value }: queryVerifyMembershipResponseParams): EncodeObject {
			try {
				return { typeUrl: "/ibc.core.client.v1.QueryVerifyMembershipResponse", value: QueryVerifyMembershipResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryVerifyMembershipResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryClientCreatorRequest({ value }: queryClientCreatorRequestParams): EncodeObject {
			try {
				return { typeUrl: "/ibc.core.client.v1.QueryClientCreatorRequest", value: QueryClientCreatorRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryClientCreatorRequest: Could not create message: ' + e.message)
			}
		},
		...
		msgDeleteClientCreatorResponse({ value }: msgDeleteClientCreatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/ibc.core.client.v1.MsgDeleteClientCreatorResponse", value: MsgDeleteClientCreatorResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgDeleteClientCreatorResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryClientCreatorResponse({ value }: queryClientCreatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/ibc.core.client.v1.QueryClientCreatorResponse", value: QueryClientCreatorResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryClientCreatorResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryVerifyMembershipRequest({ value }: queryVerifyMembershipRequestParams): EncodeObject {
			try {
				return { typeUrl: "/ibc.core.client.v1.QueryVerifyMembershipRequest", value: QueryVerifyMembershipRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryVerifyMembershipRequest: Could not create message: ' + e.message)
			}
		},

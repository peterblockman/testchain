...
export { GroupInfo, MsgUpdateGroupPolicyMetadata, MsgExec, PercentageDecisionPolicy, MsgCreateGroupPolicy, EventUpdateGroupPolicy, EventSubmitProposal, EventVote, QueryGroupPolicyInfoResponse, QueryGroupsByAdminRequest, QueryVoteByProposalVoterResponse, QueryGroupPoliciesByAdminResponse, QueryProposalRequest, QueryGroupsRequest, MsgUpdateGroupMetadataResponse, MsgWithdrawProposal, MsgVote, GenesisState, MsgUpdateGroupAdminResponse, MsgUpdateGroupPolicyAdmin, MsgUpdateGroupPolicyAdminResponse, MsgCreateGroupWithPolicyResponse, MsgUpdateGroupPolicyDecisionPolicyResponse, MsgVoteResponse, MsgLeaveGroup, EventCreateGroup, EventWithdrawProposal, EventExec, MsgUpdateGroupPolicyDecisionPolicy, EventProposalPruned, QueryVoteByProposalVoterRequest, QueryTallyResultResponse, MsgLeaveGroupResponse, Proposal, EventLeaveGroup, QueryGroupMembersRequest, QueryVotesByVoterResponse, MemberRequest, MsgUpdateGroupPolicyMetadataResponse, GroupMember, EventCreateGroupPolicy, QueryGroupPolicyInfoRequest, QueryGroupMembersResponse, QueryProposalsByGroupPolicyRequest, QueryVotesByProposalRequest, MsgUpdateGroupMembersResponse, MsgWithdrawProposalResponse, Member, MsgCreateGroupPolicyResponse, MsgSubmitProposalResponse, MsgExecResponse, TallyResult, MsgUpdateGroupMetadata, QueryVotesByVoterRequest, QueryGroupsResponse, MsgCreateGroupWithPolicy, QueryGroupInfoResponse, QueryGroupPoliciesByGroupRequest, QueryGroupsByMemberRequest, MsgCreateGroupResponse, GroupPolicyInfo, Vote, MsgUpdateGroupMembers, EventUpdateGroup, QueryGroupInfoRequest, QueryGroupsByAdminResponse, QueryProposalsByGroupPolicyResponse, ThresholdDecisionPolicy, DecisionPolicyWindows, MsgUpdateGroupAdmin, EventTallyError, QueryGroupPoliciesByAdminRequest, QueryProposalResponse, QueryTallyResultRequest, MsgCreateGroup, QueryGroupPoliciesByGroupResponse, MsgSubmitProposal, QueryVotesByProposalResponse, QueryGroupsByMemberResponse };
...
type sendEventTallyErrorParams = {
  value: EventTallyError,
  fee?: StdFee,
  memo?: string
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendEventTallyError({ value, fee, memo }: sendEventTallyErrorParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendEventTallyError: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.eventTallyError({ value: EventTallyError.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendEventTallyError: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		eventTallyError({ value }: eventTallyErrorParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.group.v1.EventTallyError", value: EventTallyError.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:EventTallyError: Could not create message: ' + e.message)
			}
		},
